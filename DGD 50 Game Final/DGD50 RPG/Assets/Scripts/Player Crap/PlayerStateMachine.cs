...
public class PlayerStateMachine : MonoBehaviour
{
    ...
    private IEnumerator TimeForAction()
    {
        ...
        enemyToAttack.gameObject.GetComponent<SpriteRenderer>().color = new Color32(157, 71, 71,255);
        if (GM.pickedMagic)
        {
            Particles.Emit(20);
        ...
        enemyToAttack.gameObject.GetComponent<SpriteRenderer>().color = new Color32(248, 233, 233,255);
